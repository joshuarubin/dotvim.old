...
let g:syntastic_go_gometalinter_args = "--vendor --tests --enable-gc --concurrency=7 -D gocyclo -D structcheck -D varcheck -D aligncheck -D testify -D test -D interfacer -D unconvert -D dupl -E misspell -E unused -E gofmt"
